			...
			if typeFound && !typeModel.IsPair {
				...
				if mapTypeName != "" {
					...
					if mapTypeName == "string" {
						...
						code.Print("if context.PatternFieldProtoGenerators != nil && len(*(context.PatternFieldProtoGenerators)) != 0 {")
						code.Print("  for _, patternFieldProtoGenerator := range *(context.PatternFieldProtoGenerators) {")
